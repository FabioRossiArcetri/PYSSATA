...
class Layer(ElectricField):
    ...
    def __init__(self, dimx, dimy, pixel_pitch, height, device_idx=None, precision=None, shiftXYinPixel=(0.0, 0.0), rotInDeg=0.0, magnification=1.0):
        super().__init__(dimx, dimy, pixel_pitch, device_idx=device_idx, precision=precision)
        self._height = height
