...
def compute_zern_ifunc(dim, nzern, obsratio=0.0, diaratio=1.0, start_mode=0, mask=None, xp=None, adtype=None):
    ...
    zern_phase_2d = xp.array([zern_phase_3d[i][idx] for i in range(nzern)], dtype=adtype)
