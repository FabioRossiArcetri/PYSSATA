...
slopec_MORFEO = {
  ...
  'GPU': False,
 'class':              'SlopeComputer',
 'pupdata_object':   'scao_pup',             # tag of Pupdata fits file
 'pupdata_data':     'scao_pup',             # tag of numpy array fits file
 'slopes_object':    'scao_sn2'               # tag of the slope reference vector
}
